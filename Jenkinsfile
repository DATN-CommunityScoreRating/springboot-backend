    ...
    stages {
        ...
        stage ('Deploy with docker'){
            steps{
                ...
                sh 'docker run -dp 9090:8080 --env DB_HOST --env DB_PORT --env DB_NAME --env DB_USER --env DB_PASS --env REDIS_HOST --env REDIS_PORT --env KAFKA_HOST --env KAFKA_PORT --name --env CLOUDINARY_NAME --env CLOUDINARY_KEY --env CLOUDINARY_SECRET capstone-backend-container anhdai0801/capstone-project-backend'
            }
        }
    }
}