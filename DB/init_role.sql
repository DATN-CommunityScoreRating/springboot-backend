...
insert into community_score_bkdn.roles(role_id, role_name, description) value (5, 'YOUTH_UNION', 'youth union');
insert into community_score_bkdn.roles(role_id, role_name, description) value (6, 'ADMIN', 'Phong cong tac sinh vien');