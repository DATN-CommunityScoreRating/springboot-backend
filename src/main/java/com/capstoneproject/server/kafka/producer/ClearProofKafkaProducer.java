...
@Service
@Log4j2
public class ClearProofKafkaProducer {
    private final KafkaTemplate<String, Object> kafkaTemplate;

    public ClearProofKafkaProducer(@Qualifier("CommunityScoreKafkaTemplate") KafkaTemplate<String, Object> kafkaTemplate){
    ...
    public void sendActivityClearProof(SendActivityClearProofMessage message){
        publish(Constant.KAFKA.SEND_CLEAR_PROOF_TOPIC, message);
    }
